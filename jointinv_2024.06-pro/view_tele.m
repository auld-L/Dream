...
datafolder = 'D:\matlab2021\codes\jtinew2022.09\2008-05-12-mw79-sichuan-chinaBH';

% Ordinal numbers of stations that are to exclude from the inversion

%deldex=[26,31,32,42,43,44];
%deldex=[43,44,46];
deldex=[];
...
save ob_telewenchuanbeforeright.mat ob loca da mm srate leng leng_before
