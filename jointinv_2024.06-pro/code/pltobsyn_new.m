function [misfitall,fit]=pltobsyn_new(ob,syn,t,rc,rat,station,phacom,flag)
%==========================================================================
syn1=syn;
ob1=ob;
syn1(ob1==0)=0;
...
ob(ob==0)=nan;
%==========================================================================
misfitall=sum((ob1-syn1).^2)./sum((ob1).^2);
if nargin==4
    rat=0.05;
    station=[];
    phacom=[];flag=1;
...
%             'fontsize',5,'HorizontalAlignment','left','VerticalAlignment','top');
                ...
                text(nt+(mt-nt)*0.00,-2*j-0.03,{num2str_zh(misfitall((i-1)*rc(1)+j),2);num2str_zh(fit0(j),2)},...
